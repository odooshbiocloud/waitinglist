...
install the waiting_list_enterprise module.
""",
    'author': 'Mazen',
    ...
    'assets': {
        'web.assets_backend': [
            'waiting_list_base/static/src/scss/waiting_list.scss',
            'waiting_list_base/static/src/js/dashboard.js',
        ],
    },
    'demo': [],
    'installable': True,
