...
- **waiting_list_enterprise**: Advanced table layouts with pos_restaurant integration, VIP priority, enhanced analytics
- **waiting_list_foodics**: Foodics POS integration for seamless order management
- **waiting_list_spreadsheet**: Advanced reporting with Odoo Spreadsheet integration
- **whatsapp_waitinglist**: WhatsApp notification integration
